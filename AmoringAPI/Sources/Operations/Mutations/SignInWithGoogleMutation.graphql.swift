...
public class SignInWithGoogleMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation signInWithGoogle($idToken: String!) { signInWithGoogle(idToken: $idToken) { __typename sessionToken user { __typename ...UserInfo } } }"#,
      fragments: [BusinessHoursInfo.self, BusinessInfo.self, CheckInInfo.self, ImageFragment.self, ProfileInfo.self, UserInfo.self]
    ))
    ...
    public struct SignInWithGoogle: AmoringAPI.SelectionSet {
      ...
      public struct User: AmoringAPI.SelectionSet {
        ...
        public struct Profile: AmoringAPI.SelectionSet {
          ...
          /// SignInWithGoogle.User.Profile.ActiveCheckIn
          ///
          /// Parent Type: `CheckIn`
          public struct ActiveCheckIn: AmoringAPI.SelectionSet {
            ...
            /// SignInWithGoogle.User.Profile.ActiveCheckIn.Business
            ///
            ...
            public struct Business: AmoringAPI.SelectionSet {
              ...
              /// SignInWithGoogle.User.Profile.ActiveCheckIn.Business.BusinessHour
              ///
        ...
        public struct Business: AmoringAPI.SelectionSet {
          ...
          /// SignInWithGoogle.User.Business.BusinessHour
          ///
          /// Parent Type: `BusinessHours`
          public struct BusinessHour: AmoringAPI.SelectionSet {
            public let __data: DataDict
