...
public class UploadMyProfileImagesMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation uploadMyProfileImages($image: Upload!, $sort: Int!) { uploadMyProfileImages(data: [{ sort: $sort, file: $image }]) { __typename id profileId fileId sort file { __typename id name mimetype url path width height createdAt updatedAt } createdAt updatedAt } }"#
    ))
  ...
  public struct Data: AmoringAPI.SelectionSet {
    ...
    public struct UploadMyProfileImage: AmoringAPI.SelectionSet {
      ...
      public static var __parentType: any ApolloAPI.ParentType { AmoringAPI.Objects.ProfileImage }
      public static var __selections: [ApolloAPI.Selection] { [
