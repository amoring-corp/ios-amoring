...
public class ConversationsQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      ...
      fragments: [BusinessHoursInfo.self, BusinessInfo.self, CheckInInfo.self, ConversationInfo.self, ImageFragment.self, MessageInfo.self, ProfileInfo.self, UserInfo.self]
    ))
    ...
    public struct Conversation: AmoringAPI.SelectionSet {
      ...
      public struct Participant: AmoringAPI.SelectionSet {
        ...
        public struct Profile: AmoringAPI.SelectionSet {
          ...
          /// Conversation.Participant.Profile.ActiveCheckIn
          ///
          /// Parent Type: `CheckIn`
          public struct ActiveCheckIn: AmoringAPI.SelectionSet {
            ...
            /// Conversation.Participant.Profile.ActiveCheckIn.Business
            ///
            /// Parent Type: `Business`
            public struct Business: AmoringAPI.SelectionSet {
              public let __data: DataDict
