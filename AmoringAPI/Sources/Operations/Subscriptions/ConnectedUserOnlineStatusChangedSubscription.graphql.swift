...
public class ConnectedUserOnlineStatusChangedSubscription: GraphQLSubscription {
  public static let operationName: String = "ConnectedUserOnlineStatusChanged"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"subscription ConnectedUserOnlineStatusChanged { connectedUserOnlineStatusChanged { __typename ...UserInfo } }"#,
  ...
  public struct Data: AmoringAPI.SelectionSet {
    ...
    public static var __selections: [ApolloAPI.Selection] { [
      .field("connectedUserOnlineStatusChanged", ConnectedUserOnlineStatusChanged?.self),
    ] }

    public var connectedUserOnlineStatusChanged: ConnectedUserOnlineStatusChanged? { __data["connectedUserOnlineStatusChanged"] }

    /// ConnectedUserOnlineStatusChanged
    ///
    /// Parent Type: `User`
    public struct ConnectedUserOnlineStatusChanged: AmoringAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }
